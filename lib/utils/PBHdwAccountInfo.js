class PBHdwAccountInfo {
  constructor(
    purpose, account, timestamp, name, cryptocurrencyType, uid, accountIndex,
   ...
   */
  static forCreateAccount(purpose, account, timestamp, name, cryptocurrencyType) {
    const obj = new PBHdwAccountInfo(
      purpose, account, timestamp, name, cryptocurrencyType,
   ...
   * @param {PBCryptocurrencyType} cryptocurrencyType
   */
  static forCreateSpecificAccount(purpose, account, timestamp, name, cryptocurrencyType) {
    const obj = new PBHdwAccountInfo(
      purpose, account, timestamp, name, cryptocurrencyType,
