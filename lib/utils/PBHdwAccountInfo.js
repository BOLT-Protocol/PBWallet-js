class PBHdwAccountInfo {
  constructor(
    account, timestamp, name, cryptocurrencyType, uid, accountIndex,
   ...
   */
  static forCreateAccount(account, timestamp, name, cryptocurrencyType) {
    const obj = new PBHdwAccountInfo(
      account, timestamp, name, cryptocurrencyType,
   ...
   * @param {PBCryptocurrencyType} cryptocurrencyType
   */
  static forCreateSpecificAccount(account, timestamp, name, cryptocurrencyType) {
    const obj = new PBHdwAccountInfo(
      account, timestamp, name, cryptocurrencyType,
